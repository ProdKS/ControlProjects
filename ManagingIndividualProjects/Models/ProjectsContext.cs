...
namespace ManagingIndividualProjects.Models
{
    public partial class ProjectsContext : DbContext
    {
        ...
        public virtual DbSet<FilesStudent> FilesStudents { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FilesStudent>(entity =>
            {
                entity.ToTable("FilesStudent");
                ...
                entity.Property(e => e.IndividualProjectId).HasColumnName("IndividualProjectId");

                entity.HasOne(d => d.IndividualProject)
                    .WithMany(p => p.FilesStudents)
                    .HasForeignKey(d => d.IndividualProjectId)
                    .HasConstraintName("FK_filesStudent_IndividualProjects");
            });
